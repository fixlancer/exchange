...
const CryptoList: React.FC<Props> = props => {
    const { title, lastPrice, tradeType, priceChangePercent, subTitle, ngnRate, btcPrice, subCat, navigation } = props;
    ...
    const handleClick = () => {
        navigation.navigate('SwapCrypto', { tradeType: tradeType, crypto: title, currency: subCat })
    }
