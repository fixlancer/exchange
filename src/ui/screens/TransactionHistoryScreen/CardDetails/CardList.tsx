...
const CardList: React.FC<Props> = props => {
  ...
  const { giftcard,navigation, image, status, cardValue, createdAt , rate, tradeTitle, tradeData, country, cardType, cardCode, transValue, id,declineReason,declineReasonImage } = props;
        ...
        <View
          ...
          <View style={{ flexDirection: 'row', marginTop: 0 }}>
            ...
            <View style={{ marginLeft: 6, marginTop: 5 }}>
              <MyText style={[{ color: '#808080', fontSize: 10 }]}>{formattedDateTime(createdAt)}</MyText>
            ...
            {cardType === 'Ecode' ? (
              ...
              image ? (
                <TouchableOpacity
                  ...
                  onPress={() => previewImage({ uri:  CloudinaryBaseUrl + image })}>
                  ...
                  {declineReasonImage?.map((item, index) => (
                    <View key={item}>
                      {item ? (
                        <TouchableOpacity
                          activeOpacity={0.9}
                          onPress={() => previewImage({ uri: CloudinaryBaseUrl + item })}>
                          <Image
